...
export class DataService {
  ...
  ELEMENT_DATA: Card[] = [
    ...
    {position: 6, title: 'Card Six', category: 'Game 2', date_posted: new Date(), body: 'Body 6'},
    {position: 7, title: 'Card Six', category: 'Game 2', date_posted: new Date(), body: 'Body 6'},
    {position: 8, title: 'Card Six', category: 'Game 2', date_posted: new Date(), body: 'Body 6'},
    {position: 9, title: 'Card Six', category: 'Game 2', date_posted: new Date(), body: 'Body 6'},
  ];
  categories = [
