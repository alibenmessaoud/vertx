...
@Component({
  selector: 'app-card-body-l21',
  templateUrl: './card-body-l21.component.html',
  styleUrls: ['./card-body-l21.component.css']
})
export class CardBodyL21Component implements OnInit, OnDestroy, AfterContentInit {
  ...
  ngOnInit() {
    this.gridConfig = Commons.getGridConfig('21');
